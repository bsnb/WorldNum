...
public class InlNumActivity extends ListActivity implements Runnable {
    Handler handler;
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 7) {
                    ...
                    ListAdapter adapter = new ArrayAdapter<String>(InlNumActivity.this, android.R.layout.simple_list_item_1, list2);
